...
const UUID = process.env.UUID || '6e71da74-73c3-42c7-80fd-568f0ee7c283'; // 运行哪吒v1,在不同的平台需要改UUID,否则会被覆盖
const NEZHA_SERVER = process.env.NEZHA_SERVER || '127.0.0.1;       // 哪吒v1填写形式：nz.abc.com:8008   哪吒v0填写形式：nz.abc.com
